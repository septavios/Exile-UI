...
export class ModDatabase {
  private mods: ModDef[] = [];
  private modsByFamily: Record<string, ModDef[]> = {};
  public bases: Record<string, any> = {}; // Public for main access
  ...
  private processCategory(categoryData: Record<string, any>) {
